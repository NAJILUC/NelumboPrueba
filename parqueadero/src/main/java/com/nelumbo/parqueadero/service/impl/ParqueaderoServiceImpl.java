...
public class ParqueaderoServiceImpl implements ParqueaderoService {
    ...
    public ParqueaderoResponse agregarParqueadero(ParqueaderoRequest parqueaderoRequest) {
        ...
        try {
            ...
            return new ParqueaderoResponse(parqueadero.getNombre(),parqueadero.getVehiculosMaximos(),
    ...
    public ParqueaderoResponse actualizarParqueadero(Long id, ParqueaderoActualizarRequest parqueaderoActualizarRequest) {
        ...
        return new ParqueaderoResponse(parqueadero.getNombre(),parqueadero.getVehiculosMaximos(),parqueadero.getCosto()
    ...
    public List<ParqueaderoResponse> verParqueaderos() {
        ...
        for (Parqueadero parqueadero:parqueaderos) {
            if(parqueadero.getUsuario()==null)
                parqueaderosResponses.add(new ParqueaderoResponse(parqueadero.getNombre(),parqueadero.getVehiculosMaximos(),parqueadero.getCosto()
                        ,"Sin socio asociado"));
            else parqueaderosResponses.add(new ParqueaderoResponse(parqueadero.getNombre(),parqueadero.getVehiculosMaximos(),parqueadero.getCosto()
                    ,parqueadero.getUsuario().getCorreo()));
        }
